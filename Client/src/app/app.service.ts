...
export class AppService {
  ...
  public getDeliveryMethods() {
    return [
      { value: 'free', name: 'Free Delivery', desc: '$0.00 / 10 a 14 días hábiles de entrega','precio':0 },
      { value: 'standard', name: 'Standard Delivery', desc: '$7.99 / 7 a 9 días hábiles de entrega', 'precio':7.99},
      { value: 'express', name: 'Express Delivery', desc: '$29.99 / 1 día hábil de entrega','precio':29.99 }
    ]
  }
